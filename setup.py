...
if __name__ == '__main__':
    ...
    if not noRequirements:
        ...
        try:
            ...
            os.system("sudo sudo apt install nmap tcpdump python3-pip python3-dev libffi-dev libssl-dev libxml2-dev libxslt1-dev libjpeg62-turbo-dev zlib1g-dev screen -y")
